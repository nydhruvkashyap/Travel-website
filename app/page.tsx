...
// Updated: Replacing HTML entities with their actual characters to prevent TypeScript errors
const categories = [
  {
    name: "Cultural Tourism",
    link: "/categories/cultural-tourism",
    image: "/images/cultural.jpg",
    caption: "Unravel India’s history with stories behind palaces, forts, and ancient traditions.",
  },
  {
    name: "Adventure Tourism",
    link: "/categories/adventure-tourism",
    image: "/images/adventure.jpg",
    caption: "Guided treks, safe explorations, and thrill-packed experiences across India.",
  },
  {
    name: "Beach & Coastal Tourism",
    link: "/categories/beach-coastal-tourism",
    image: "/images/beach.jpg",
    caption: "Find the perfect coastal escape—from serene retreats to vibrant beach towns.",
  },
  {
    name: "Spiritual & Wellness Tourism",
    link: "/categories/spiritual-wellness-tourism",
    image: "/images/spiritual.jpg",
    caption: "Discover India’s spiritual heart through ancient wellness practices and retreats.",
  },
  {
    name: "Festivals & Events",
    link: "/categories/festivals-events-tourism",
    image: "/images/festivals.jpg",
    caption: "Experience India’s festivals like a local—vibrant, immersive, and unforgettable.",
  },
  {
    name: "Culinary Tourism",
    link: "/categories/culinary-tourism",
    image: "/images/culinary.jpg",
    caption: "Savor India’s rich flavors, from street food to royal feasts.",
  },
];
      ...
      <main className="bg-gray-50 min-h-screen">
        ...
        <section className="relative w-full h-screen flex items-center justify-center bg-gray-100 mt-16">
          ...
          <div className="relative z-10 bg-black bg-opacity-60 p-8 rounded-xl text-white text-center max-w-2xl">
            ...
            <p className="text-lg mt-4">
              Planning a trip to India can feel overwhelming—so much to see, but where to begin?
            </p>
          </div>
        </section>
        ...
        <div className="text-center px-6 py-12 max-w-3xl mx-auto">
          ...
          <p className="text-lg text-gray-600 mt-4">
            Mythara helps travelers navigate India effortlessly, uncovering experiences that match
            your interests, comfort, and curiosity.
          </p>
        </div>
        ...
        <div className="p-8 text-center">
          ...
          <p className="text-lg text-gray-600 mt-2">
            Read through India’s vast expanse of travel experiences and identify the ones that match
