  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="mb-12 text-lg leading-relaxed text-gray-800">
        <p className='text-xl leading-relaxed'>Everything in India happens at a scale you&rsquo;ve never witnessed before! From spiritual gatherings to art festivals, cricket stadiums to neon-lit concerts, every experience is a chance to be part of something unforgettable.</p>
      </section>
      ...
      <div className="space-y-16">
        ...
        <div className="flex flex-col md:flex-row-reverse items-center gap-8">
          ...
          <div>
            ...
            <p className='text-xl leading-relaxed'>From the Jaipur Literature Festival&rsquo;s intellectual buzz to Mumbai&rsquo;s street art transforming entire neighborhoods, India celebrates creativity in all forms. Music, film, dance, and art festivals bring global voices and local traditions together in an endless flow of ideas.</p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div>
            ...
            <p className='text-xl leading-relaxed'>From sold-out Coldplay concerts and Goa&rsquo;s Sunburn Festival to Mumbai&rsquo;s buzzing club scene and vineyard tours in Nashik&mdash;India&rsquo;s nightlife and entertainment culture is more dynamic than ever.</p>
          </div>
        </div>
      </div>
