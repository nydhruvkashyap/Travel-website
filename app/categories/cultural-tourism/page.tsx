  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="mb-12 text-lg leading-relaxed text-gray-800">
        <p className='text-xl leading-relaxed'>India&rsquo;s cultural heritage is a living story, shaped over thousands of years. Whether you&rsquo;re exploring ancient forts, witnessing vibrant festivals, or sharing a meal with a local family, cultural tourism in India offers an immersive experience beyond sightseeing.</p>
      </section>
      ...
      <div className="space-y-16">
        ...
        <div className="flex flex-col md:flex-row-reverse items-center gap-8">
          ...
          <div>
            ...
            <p className='text-xl leading-relaxed'>Experience the deep spirituality woven into India&rsquo;s culture. Witness the grandeur of temple processions, explore ancient mosques, and be part of devotional ceremonies along the sacred Ganges River.</p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div>
            ...
            <p className='text-xl leading-relaxed'>From Holi&rsquo;s explosion of colors to Diwali&rsquo;s dazzling lights, India&rsquo;s festivals are immersive experiences. Dance through Navratri celebrations, witness grand processions, and experience the joy of shared traditions.</p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row-reverse items-center gap-8">
          ...
          <div>
            ...
            <p className='text-xl leading-relaxed'>Every dish in India tells a story. Savor the bold spices of Mughlai cuisine, enjoy crispy dosas in the South, or dive into the bustling street food markets of Delhi. Food is not just a meal—it&rsquo;s an adventure through taste and tradition.</p>
          </div>
        </div>
