  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="relative w-full h-64 mb-12">
        <Image src="/images/hero-wellness.jpg" alt="Spiritual & Wellness Tourism in India: Where Healing Meets the Soul" layout="fill" objectFit="cover" className="rounded-lg" />
        <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-30">
          <h1 className="text-4xl font-bold text-white">Spiritual & Wellness Tourism in India: Where Healing Meets the Soul</h1>
        </div>
      </div>

      {/* Section: Introduction */}
      <section className="mb-12 text-lg leading-relaxed text-gray-800">
        <p className='text-xl leading-relaxed'>Some come to India seeking wisdom. Others come searching for healing. Many arrive not knowing what they seek—only to leave transformed. From the meditation retreats of the Himalayas to Ayurveda therapies in Kerala, wellness and spirituality intertwine, offering journeys of healing, devotion, and self-discovery.</p>
      </section>
      ...
      <div className="space-y-16">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          <Image src="/images/religious-pilgrimage.jpg" alt="Sacred Pilgrimage Journey in India – Varanasi, Golden Temple, and Himalayan Monasteries" width={400} height={260} className="rounded-lg" />
          <div>
            <h2 className="text-3xl font-semibold mb-4">Pilgrimage & Sacred Journeys – Footsteps of the Divine</h2>
            <p className='text-xl leading-relaxed'>Follow the footsteps of countless seekers who have walked these sacred paths for millennia. Whether at the banks of the Ganges in Varanasi, the steps of the Golden Temple in Amritsar, or the mountain monasteries where prayer flags flutter in the wind, faith in India is not just seen—it is experienced.</p>
          </div>
        </div>
      </div>
