  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="mb-12 text-lg leading-relaxed text-gray-800">
        <p className='text-xl leading-relaxed'>Not all who wander are lost&mdash;some are just chasing the next thrill. Adventure tourism in India offers an unparalleled mix of high-altitude treks, untamed wilderness, and adrenaline-fueled water escapades. Whether you seek trekking in the Himalayas, jungle safaris, or diving in the Andamans, the wild is calling.</p>
      </section>
      ...
      <div className="space-y-16">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          <Image src="/images/safari-tiger.jpg" alt="Jeep Safari with Bengal Tiger in India&rsquo;s Jungles" width={400} height={260} className="rounded-lg" />
          <div>
            <h2 className="text-3xl font-semibold mb-4">Wildlife Safaris in India – Step Into the Unknown</h2>
            <p className='text-xl leading-relaxed'>There&rsquo;s a moment when you&rsquo;re deep in the wild—when the jungle goes silent, and you know something is watching. Maybe it&rsquo;s a Bengal tiger, moving like a shadow between the trees. Maybe it&rsquo;s a herd of elephants, their presence as commanding as the land itself.</p>
            <p className='text-xl leading-relaxed'>This isn&rsquo;t a zoo. There are no fences, no schedules—just you, the raw power of nature, and the pulse of a land that never lost its wild heart.</p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row-reverse items-center gap-8">
          ...
          <div>
            ...
            <p className='text-xl leading-relaxed'>The Himalayas, the Western Ghats, and the Aravallis aren&rsquo;t just mountains; they&rsquo;re stories written in rock and time. Trails wind through pine-scented valleys, rugged passes where the air is thin and crisp, and hidden villages where time moves at its own pace.</p>
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div>
            ...
            <p className='text-xl leading-relaxed'>Water—wild, untamed, endless. One moment, you&rsquo;re riding the rapids, your raft twisting through foamy white waters. The next, you&rsquo;re beneath the waves, surrounded by an alien world where vibrant corals stretch out like underwater forests.</p>
        ...
        <div className="flex flex-col md:flex-row-reverse items-center gap-8">
          ...
          <div>
            ...
            <p className='text-xl leading-relaxed'>Stand on a living root bridge in Meghalaya, feeling the power of nature&rsquo;s own architecture beneath your feet. Descend into caves where underground rivers whisper secrets in the dark. Chase the mist as you hike through the Shola forests, where every bend in the path reveals a landscape straight out of a dream.</p>
          </div>
        </div>
      </div>
